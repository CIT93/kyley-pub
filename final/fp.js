class FP {
  constructor(first, last, houseMembers, houseSize, foodChoice, otherFood, waterConsumption, waterDoubled, housePurchase, wastePoints, recycle, personalPoints, publicPoints, flightPoints) {
    this.first = first;
    this.last = last;
